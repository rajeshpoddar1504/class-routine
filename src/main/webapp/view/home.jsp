...
<body>
	...
	<div class="container mt-5 px-1 canvas_div_pdf" id="htmlContent">
		...
		<div class="m-4">
			Select Year/Smester <select class="" id="semesterSelect">
				<option selected="selected" disabled="disabled" value="">--Select--</option>
				<c:forEach items="${routine_batches }" var="routine_batch">
					<option value="${routine_batch.batchAbbr }">${routine_batch.batchDesc }</option>
				</c:forEach>
			</select>
		</div>
